...
- **Realm의 DTO 사용하여 데이터의 안정성과 일관성을 높임:**<br>
...
ViewModel에 의존성 주입(DI)을 적용하여 View와 ViewModel의 의존성을 줄이고, 테스트 가능성을 높였습니다.

- **NSURLErrorDomain을 사용하여 네트워크 에러 세분화 처리:**<br>
인터넷 연결 오류, 서버 응답 오류, 타임아웃 등을 세분화하여 처리하고 상세한 오류 메시지를 전달하여 사용자의 경험을 개선하였습니다.
